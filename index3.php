			...
			<div class="row">
				<div class="col-md-8">
					<div class="jumbotron">
						...
						<?php
						require "koneksi.php";
						$query = mysqli_query($koneksi, "SELECT * FROM artikel where id_artikel >= 10 and id_artikel <= 12");
					...
					//menggunakan while dan definisikan kedalam variabel data
							...
							{
								$art = substr($data['isi_artikel'],0,400);
							...
							//kita akan menampilkan judul artikel
								...
								echo '<h5 align="justify">'.$art.'.....</h5><a href="viewindex.php?p='.$data['id_artikel'].'">Read More</a>
								</div>';
							}
						}
						?>
						<div class="col-md-4">
							<h5>  Lihat Selanjutnya =======></h5>
						</div>
						<div class="col-md-1">
							<a href="index.php" class="btn btn-primary">1</a>
						</div>
						<div class="col-md-1">
							<a href="index1.php" class="btn btn-primary">2</a>
						</div>
						<div class="col-md-1">
							<a href="index2.php" class="btn btn-primary">3</a>
						</div>
						<div class="col-md-1">
							<a href="index3.php" class="btn btn-primary">4</a>
						</div>
