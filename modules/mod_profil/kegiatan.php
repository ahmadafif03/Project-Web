						...
						<div id="navbar" class="collapse navbar-collapse">
							<ul class="nav navbar-nav">
								...
								<li>
									...
									<ul class="dropdown-menu">
										<li><a href="../mod_pendaftaran/pendaftaran.php">Daftar Santri Baru</a></li>
										<li><a href="../mod_pendaftaran/info.php">Info Pendaftaran</a></li>
									</ul>
								</li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<div class="jumbotron">
						<div class="row">
							<h2><strong>Daftar Kegiatan Pondok Pesantren Daar El-Hikmah</strong></h2><br>
							<p align="center">
								<h4><strong>Jadwal Kegiatan Pondok</strong></h4><br>
								<img src="../../img/jadwal.jpg" width="100%">
								<ul>
									<h3><strong>Kegiatan Mingguan</strong></h3><br>
									<li>Tahlilan Bersama</li>
									<li>Pramuka</li>
									<li>Bela Diri</li>
									<li>Futsal</li>
									<li>Renang</li><br>

									<h3><strong>Kegiatan Bulanan</strong></h3><br>
									<li>OutBond/ Rekreasi</li>
									<li>Silaturrahmi</li>
									<li>Kerja Bakti Massal</li><br>

									<h3><strong>Kegiatan Tahunan</strong></h3><br>
									<li>Pendaftaran Santri Baru</li>
									<li>Karantina Peserta Seleksi</li>
									<li>Penyembelihan Hewan Qurban</li>
									<li>Wisuda Khatmil Qur'an</li>
									<li>UAS / UAN (Kelas VI)</li>
									<li>Wisuda Akhirussanah MTS/MA</li><br>
