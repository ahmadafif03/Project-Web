					...
					<div class="navbar navbar-inverse">
						...
						<div id="navbar" class="collapse navbar-collapse">
							<ul class="nav navbar-nav">
								...
								<li><a href="album_photo.php">Galery</a></li>
				...
				<div class="col-md-8">
					...
					//menggunakan while dan definisikan kedalam variabel data
						while ($data = mysqli_fetch_array($query)) 
						{
							...
							<a href="../../login/admin/galery/images/<?php echo $data['gambar']; ?>">
							<img src="../../login/admin/galery/images/<?php echo $data['gambar']; ?>" width="200px" height="150px"  class="img-rounded" ></a>
							</div>
