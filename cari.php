				...
				<div class="col-md-12">
					<div class="navbar navbar-inverse">
						...
						<div id="navbar" class="collapse navbar-collapse">
							...
							<form method="post" action="" class=" search pull-right col-md-4">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="jumbotron">
						...
						require "koneksi.php";
						if (isset($_POST['cari'])) {
							$cari = $_POST['judul_artikel'];
							$query = mysqli_query ($koneksi,"SELECT * FROM artikel where judul_artikel like '%".$cari."%'");
							}
							...
							<tr>
								<td><h3><strong><?php echo $data['judul_artikel'] ?></strong></h3></td>
								<td><p><em><?php echo $data['tgl_artikel'] ?></em></p></td>
								<td> <?php echo "<img src='login/admin/posts/images/".$data['gambar'] ."'width='100%'/>";?></td>
						...
						<div class="tab-pane fade in active" id="konten1">
							...
							else 
							{
								while ($data = mysqli_fetch_array($query)) 
								{
									...
									<ul> 
									<li>';
									echo "<a herf='index1.php'><img src='login/admin/posts/images/".$data['gambar'] ."'width='100%' class='img-rounded' alt='Cinque Terre'/></a><p> " .$data['judul_artikel']."</p>
									</li>
									</ul>";
								}
							}
